...
import com.tnpy.datacollector.lognet.Core.ILogNet;
...
public abstract class NetworkBase {
     ...
     * @return 消息类
     */
    protected <TNetMessage extends INetMessage> OperateResultExOne<TNetMessage> ReceiveMessage(Socket socket,
	    int timeOut, TNetMessage netMsg) {
