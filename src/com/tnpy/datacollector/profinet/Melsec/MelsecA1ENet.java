...
import com.tnpy.datacollector.core.IMessage.MelsecA1EBinaryMessage;
...
public class MelsecA1ENet extends NetworkDeviceBase<MelsecA1EBinaryMessage, RegularByteTransform> {
	...
	// 错误代码验证
	if (read.Content[1] != 0)
	    return new OperateResultExOne<>(read.Content[1],
	...
	if (read.Content[1] != 0)
	    return new OperateResultExOne<byte[]>(read.Content[1],
		    StringResources.Language.MelsecPleaseReferToManulDocument());
