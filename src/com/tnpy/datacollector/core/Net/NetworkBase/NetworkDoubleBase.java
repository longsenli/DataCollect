...
import com.tnpy.datacollector.core.Net.StateOne.AlienSession;
import com.tnpy.datacollector.core.Transfer.ByteTransformHelper;
...
public class NetworkDoubleBase<TNetMessage extends INetMessage, TTransform extends IByteTransform> extends NetworkBase {
    ...
    /***************************************************************************************
     *
     * 主要的数据交互分为4步 1. 连接服务器，或是获取到旧的使用的网络信息 2. 发送数据信息 3. 接收反馈的数据信息 4. 关闭网络连接，如果是短连接的话
     *
     **************************************************************************************/
