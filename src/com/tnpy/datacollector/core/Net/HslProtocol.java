...
import com.tnpy.datacollector.basicframework.SoftZipped;
import com.tnpy.datacollector.core.Security.HslSecurity;
...
public class HslProtocol {
	...
	if (data == null)
	    ...
	    return CommandBytes(ProtocolUserString, customer, token, Utilities.string2Byte(data));
    }
