...
import com.tnpy.datacollector.enthernet.ComplexNet.NetComplexClient;
import com.tnpy.datacollector.enthernet.PushNet.NetPushClient;
import com.tnpy.datacollector.enthernet.SimplifyNet.NetSimplifyClient;
import com.tnpy.datacollector.modbus.ModbusTcpNet;
import com.tnpy.datacollector.profinet.Melsec.MelsecA1ENet;
import com.tnpy.datacollector.profinet.Melsec.MelsecMcAsciiNet;
import com.tnpy.datacollector.profinet.Melsec.MelsecMcNet;
...
public class Main {
	...
	try {
	    ...
	    // System.out.println(Utilities.bytes2HexString(
	    // Utilities.getBytes(String.format("%04x",100),"ASCII")));
	    ...
	    // SiemensS7Net siemensS7Net = new
	    // SiemensS7Net(SiemensPLCS.S1200,"192.168.8.12");
