...
import com.tnpy.datacollector.core.IMessage.HslMessage;
...
public class NetSimplifyClient extends NetworkDoubleBase<HslMessage, RegularByteTransform> {
	...
	OperateResultExOne<byte[]> temp = ReadFromServerBase(HslProtocol.ProtocolUserString, customer.get_CodeValue(),
		data);
	...
	if (contentBytes.length > 0) {
	    System.arraycopy(read.Content, HslProtocol.HeadByteLength, contentBytes, 0,
		    read.Content.length - HslProtocol.HeadByteLength);
	}
