package com.tnpy.datacollector.core.Types;
...
public class OperateResultExFour<T1, T2, T3, T4> extends OperateResult {
     ...
     * @return 结果类对象
     */
    public static <T1, T2, T3, T4> OperateResultExFour<T1, T2, T3, T4> CreateSuccessResult(T1 content1, T2 content2,
	    T3 content3, T4 content4) {
